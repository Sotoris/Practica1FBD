...
/**
 * ManipulaArchivo.java Clase general para poder escribir/leer archivos
 *
...
public class ManipulaArchivo {
    ...
    /**
     * Construye un archivo para poder editar, el archivo debe de estar a la
     * altura de la carpeta scr.
     *
     * @param nombreArchivo nombre del archivo a editar nombreArchivo debe tener
    ...
    /**
     * ---------ESTE METODO UTILIZA BUFFEr PARA LEER--------- Se encarga de leer
     * el contenido del file (archivo a editar) y lo convierte en un arreglo de
     * lineas
     *
    ...
    /**
     * ---------ESTE METODO UTILIZA SCANNER PARA LEER--------- Se encarga de
     * leer el contenido del file (archivo a editar) y lo convierte en un
     * arreglo de lineas
     *
     * @return String[] contiene como elemento cada linea del archivo
     * @throws ArchivoLecturaNoCreadoException
